			...
			<div className="b-header_wrapper">
				...
				<div className={`b-header_nav ${menuOpen ? "active" : ""}`}>
					...
					<div className="b-header_user-menu">
						<NavLink to="/account/wishlist" className="b-header_user-link">
						...
						<NavLink to={userId === "" ? "/signin" : "/account/my-info"} className="b-header_user-link">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<NavLink to="/account/cart" className="b-header_user-link">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
